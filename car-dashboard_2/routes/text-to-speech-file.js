...
var receiver_GetWavfile = new yarp.Port('bottle');
receiver_GetWavfile.open('/tts_wavfile');
...
receiver_GetWavfile.onRead(function(msg){
...
function synthesisFile(text) {
    ...
    textToSpeech.synthesize(synthesizeParams).on('error', function(error) {
        console.log(error);
    }).pipe(fs.createWriteStream('giulia.wav'));
};
